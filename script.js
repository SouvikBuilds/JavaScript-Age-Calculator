document.addEventListener("DOMContentLoaded", function () {
    ...
    const ageCalculateButton = document.getElementById("calculate-age")
    let age = document.getElementById("your-age")
    ...
    ageCalculateButton.addEventListener("click", calculateAge)
